...
const checkRegisteredUser = (sender) => {
    ...
    const ownerNumber = [`628881372457@s.whatsapp.net`]
...
/*const reply = (teks) => {
			itsmevall.sendMessage(from, teks, text, { thumbnail: iye, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jam} - ${week} ${weton} - ${date}`,body:"",previewType:"PHOTO",thumbnail:iye,sourceUrl:`https://wa.me/628881372457?text=Assalamualaikum`}}})
		}*/
...
const fakewa = (teks) => {        
itsmevall.sendMessage(from, teks, text, { thumbnail: fake, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jam} - ${week} ${weton} - ${date}`,body:"",previewType:"PHOTO",thumbnail:iye,sourceUrl:`https://wa.me/628881372457?text=Assalamualaikum`}}})
		}
...
sendEphemeral: false,
"externalAdReply": {
                "title": `Whatsapp-BOT\nXYZbot. (@namasaya.leon) •Instagram photos and Videos`,
                "body": "",
                "previewType": "PHOTO",
...
"externalAdReply": {
                "title": `Whatsapp`,
                "body": `wa.me/628881372457`,
                "mediaType": "10",
                "mediaUrl": `wa.me/628881372457`,
                "thumbnailUrl": "https://j.top4top.io/p_20682m4yj0.jpg",
                "thumbnail": iye,
                "sourceUrl": `wa.me/628881372457`,
...
async function sendFileFromUrl(from, url, caption, msg, men) {
    ...
    if (isGroup && !isVote) {
      if (budy.toLowerCase() === "vote") {
        ...
        let id_vote = sender ? sender : "628881372457@s.whatsapp.net";
...
*「 𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝘕𝘢𝘯𝘥𝘢 𝘚𝘵𝘺𝘭𝘦 」*`
	    ...
	    // console.log(e)
			...
			reply(`*Terimakasih Telah Terdaftar XYZbot*`)
		}, 2000)
        break
...
groups = itsmevall.chats.array.filter(v => v.jid.endsWith('g.us'))
              ...
              total = math(`${groups.length}*${privat.length}`)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
        ptod = "628881372457@s.whatsapp.net"
        dtod = '628881372457'
        stod = `${sender}`
        uwuu = '```'
        yoii = '*'
...
case 'bugreport':
              ...
              itsmevall.sendMessage('628881372457@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
...
case 'iggw':
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
  reply('https://instagram.com/namasaya.leon')
break
